    ...
    try:
        ...
        if ul_dl_command is not None:
            ...
            if uplink_command in uplink_list and downlink_command in downlink_list:
                ...
                if uplink_position >= 4 or (uplink_command == 'authentication_response' and downlink_command == 'security_mode_command'):
...
def main(pcap_directory,testcase_directory, mode):
    ...
    if mode == "openai":
        print("Mode 'openai' selected. Performing tasks for openai...")
        llm_type = 'openai'
        # Add logic for openai mode
    elif mode == "gemini":
        print("Mode 'gemini' selected. Performing tasks for Gemini...")
        llm_type = 'gemini'
        # Add logic for Gemini mode
    elif mode == "deepseek":
        print("Mode 'deepseek' selected. Performing tasks for deepseek...")
        llm_type = 'deepseek'
        # Add logic for Gemini mode
    else:
        print(f"Error: Invalid mode '{mode}'. Please select 'openai', or 'gemini', or 'deepseek'.")
        sys.exit(1)
    ...
    for index, name in enumerate(sorted_file_names, start=1):  # start=1 to make the index 1-based
        ...
        if path_exists:
            ...
            folder = "saved_prompts"  # Change this to your desired folder
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Select mode 'openai' or 'gemini' or 'deepseek'."
    )
